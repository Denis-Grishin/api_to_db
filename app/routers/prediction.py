...
async def create_prediction(fixture_id: int, db: Session = Depends(get_db)):
    ...
    pred_row = {
        ...
        'predictions_goals_home': prediction.get('predictions', {}).get('goals', {}).get('home'),
        'predictions_goals_away': prediction.get('predictions', {}).get('goals', {}).get('away'),
        'predictions_advice': prediction.get('predictions', {}).get('advice'),
        'predictions_percent_home': prediction.get('predictions', {}).get('percent', {}).get('home'),
        'predictions_percent_draw': prediction.get('predictions', {}).get('percent', {}).get('draw'),
        'predictions_percent_away': prediction.get('predictions', {}).get('percent', {}).get('away'),
